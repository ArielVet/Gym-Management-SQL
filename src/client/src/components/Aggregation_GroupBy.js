...
function Aggregation_GroupBy() {
	...
	const handleSubmit = (e) => {
		...
		// send data to server
		fetch("http://localhost:8080/Aggregation_GroupBy", {
			method: "POST",
	...
	return (
		<div className="aggregation-group-by">
			<form
				className="flex flex-col bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
				onSubmit={handleSubmit}
			>
				<h1 className="text-2xl"> Aggregation with GROUP BY </h1>
				<h1 className="text-ll">
					Get Log with Max Calories Burned, Grouped By Date
				</h1>
				<Divider />
...
export default Aggregation_GroupBy;
