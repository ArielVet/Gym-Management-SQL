...
import TableVertical from "../components/shared/TableVertical";
...
function Fitness() {
	...
	const handleSubmit = (e) => {
		...
		if (!userID) {
			...
			fetch("http://localhost:8080/fitness", {
				method: "POST",
				headers: {
					"Content-Type": "application/json",
				},
	...
	return (
		<div className="Join">
			...
			>
				<h1 className="text-2xl">Fitness Dashboard</h1>
				<h1 className="text-lg">View Fitness Information</h1>
				<Divider />
				...
				{fetchedData && (
					<>
						...
						<p className="mb-4">Let's see how you performed 💪</p>
						<TableVertical
